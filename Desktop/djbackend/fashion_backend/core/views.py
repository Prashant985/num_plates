...
class PopularProductList(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        queryset = models.Product.objects.filter(ratings_gte=4.0, ratings_lte=5.0);
...
class ProductListByClothesType(APIView):
    ...
    def get(self, request):
        ...
        if query:
            ...
            products_lists = list(queryset)
            random.shuffle(products_lists)

            limited_products = products_lists[:20]
